    ...
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16">
      <section className="mx-auto w-full max-w-2xl space-y-8 bg-white print:space-y-6">
            ...
            return (
              <Card key={work.company}>
                <CardHeader>
                  ...
                  {work.title && (<h4 className="font-mono text-sm leading-none">
                    {work.title}
                  </h4>)}
                </CardHeader>
                <CardContent dangerouslySetInnerHTML={{ __html: work.description }} className="mt-2 text-xs whitespace-pre-line"/>
              </Card>
            );
          })}
        </Section>
              ...
              return (
                <div key={skill.category} className="mb-1">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {skill.points.map((point) => <Badge key={point}>{point}</Badge>)}
                  </div>
                </div>
                );
            })}
        ...
        <Section className="print-force-new-page scroll-mb-16">
          <h2 className="text-xl font-bold">Пет-проеткы</h2>
