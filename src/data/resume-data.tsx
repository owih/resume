...
export const RESUME_DATA = {
  ...
  summary:
    "Привет! Я - Фронтенд-разработчик, имею ~3 года коммерческого опыта. Внимателен к деталям и стремлюсь максимально улучшить пользовательский опыт. Увлечен созданием чистого, эффективного и отзывчивого кода. Стараюсь участвовать во всех этапах разработки продукта. Ценю коллективную работу и готов вносить свой вклад. В личных проектах изучаю новые для себя новые технологии и пишу fullstack приложения.",
